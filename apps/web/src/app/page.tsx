      ...
      <main className={styles.main}>
        <section className={styles.hero}>
          <div className={styles.heroInner}>
            ...
            <p className={styles.heroLead}>
              poomgeul(품글)은 공개 라이선스 텍스트를 위한 오픈소스 번역 플랫폼입니다. 원문은
              위키처럼 공유하고, 번역본은 깃허브처럼 제안하고 머지합니다.
            </p>
        ...
        <section className={styles.sections}>
          <div>
            ...
            <div className={styles.cardGrid}>
              <Card>
                ...
                <CardBody>
                  arXiv 논문이나 기술 문서를 문장 단위로 수집하고 교정합니다. 위키처럼 모두가 하나의
                  원문을 가꾸며 번역의 단단한 기초를 세웁니다.
                </CardBody>
              </Card>
              <Card>
                ...
                <CardBody>
                  AI가 제안하는 초안을 바탕으로 번역의 진입 장벽을 낮춥니다. 사람은 맥락을 짚어
                  문장을 다듬고, 수정 근거를 투명하게 기록합니다.
                </CardBody>
              </Card>
              <Card>
                ...
                <CardBody>
                  정답은 하나가 아닙니다. 깃허브처럼 번역을 포크하고 제안하며, 동등하게 존재하는
                  여러 판본 속에서 최선의 표현을 함께 찾아갑니다.
                </CardBody>
              </Card>
            </div>
          </div>
          ...
          <div>
            ...
            <Card>
              <CardBody>
                번역 제안은 오픈 → 머지/거절/철회/스테일로만 이동합니다. 상태는 컬러 토큰과 함께
                언제나 같은 이름으로 드러납니다.
              </CardBody>
          ...
          <div>
            ...
            <Card>
              <CardBody>
                제품은 Pre-M0 단계입니다. 백엔드 API와 웹 스캐폴드가 세워져 있고, 디자인 시스템이
                방금 이 페이지에 내려앉았습니다. 로드맵과 M0 스펙은 저장소의 문서에서 확인하실 수
                있습니다.
              </CardBody>
